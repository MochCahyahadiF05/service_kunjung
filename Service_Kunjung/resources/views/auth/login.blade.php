...
<body class="hold-transition login-page" style="background-image: url({{asset('templates/img/bg.jpg')}}); background-size: cover; background-repeat: no-repeat;background-position: center;" >
<div class="login-box">
  <!-- /.login-logo -->
